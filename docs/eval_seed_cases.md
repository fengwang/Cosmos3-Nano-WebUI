...
Operators may set local paths with environment variables such as:

- `COSMOS3_FP8_MODEL_DIR=/path/to/Cosmos3-Nano-FP8-Blockwise`
- `COSMOS3_NVFP4_MODEL_DIR=/path/to/Cosmos3-Nano-NVFP4-Blockwise`
...
| EV-MIG-DOCS-SCRUB | Detect private references in the session's OWN committed docs, not only the imported source. | `docs/session_*/**`, `docs/evidence_map.md`, `docs/risk_register.md`, `docs/handoff.md` | No real private path/host/codename/repo; policy/descriptor language and generic detectors allowed. See `docs/eval_corpus/mig_s3_docs_private_scrub_recurrence.md`. | MIG-S3, MIG-S7, MIG-S8 |
